...
- [#1059](https://github.com/fluent-vue/fluent-vue/pull/1059) Drop Vue 2 support. `fluent-vue` is now Vue 3 only and no longer depends on `vue-demi` or `@vue/composition-api`. ([@Demivan](https://github.com/Demivan))
