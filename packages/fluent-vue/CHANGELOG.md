...
- [#1059](https://github.com/fluent-vue/fluent-vue/pull/1059) Drop Vue 2 support. `fluent-vue` is now Vue 3 only and no longer depends on `vue-demi` or `@vue/composition-api`.
  ...
  **Breaking changes:**
  ...
  - Removed the `vue-demi` dependency and the optional `@vue/composition-api` peer dependency. ([@Demivan](https://github.com/Demivan))

## 3.8.2

### Patch Changes

- [#996](https://github.com/fluent-vue/fluent-vue/pull/996) Make `FluentVueOptions` type available from `fluent-vue` import ([@Demivan](https://github.com/Demivan))

- [#997](https://github.com/fluent-vue/fluent-vue/pull/997) Switch to v8 for collecting coverage ([@Demivan](https://github.com/Demivan))

- [#998](https://github.com/fluent-vue/fluent-vue/pull/998) Migrate build tool from tsup to tsdown ([@Demivan](https://github.com/Demivan))

- [#997](https://github.com/fluent-vue/fluent-vue/pull/997) Switch from release-it to changesets ([@Demivan](https://github.com/Demivan))
